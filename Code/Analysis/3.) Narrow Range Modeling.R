...
NRE_QuasiGLM = ggplot(Full, aes(x = Model_Type, y = Estimate, fill = Covariates)) +
...
# Data
# full
NRE.spt = summary(narrow_full.sp)$Coef %>% data.frame()
NRE.spt = NRE.spt[-1,]
NRE.spt$Covariates = c('Median CloudFQ', 'Wetland%', 'Mean CSI',
                        'MAT', 'MAP', 'PET', 'pH', 'P',
                        'Range in MAT', 'Roughness in MDQ','Roughness in PET')

#NRE.spt = rbind(climate.spt,productivity.spt,Heterogeneity.spt,Full.spt)

NRE.spt$Model_Type = c('Full','Full','Full','Full','Full','Full','Full','Full','Full','Full','Full') 
...
##############################################################################
###############################################################################
########################## Proceed to :3) wetland dependent spp script 
