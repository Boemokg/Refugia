...
Map_1<-rast("http://data.earthenv.org/cloud/MODCF_monthlymean_01.tif")
Map_2 <-rast("http://data.earthenv.org/cloud/MODCF_monthlymean_02.tif")
Map_12 <-rast("http://data.earthenv.org/cloud/MODCF_monthlymean_12.tif")
...
CFR_data$Mean_CloudFQ <- Cloud.Maps.mean$mean/100
CFR_data$Median_CloudFQ <- Cloud.Maps.median$mean/100
...
CSI <- rast("C:/Users/Student/Downloads/csi_past.tif")
...
#add the cloud variable 
CFR_data$Mean_CSI <- CSI.mean$csi_past*-1
CFR_data$Median_CSI <- CSI.median$csi_past*-1
...
#`Read NFEPA_SQ4s_AEA' 
NFEPA <- st_read("/Users/Student/Downloads/NWM6_Beta_V3_20230714_CFR/NWM6_Beta_V3_20230714_CFR.dbf")
