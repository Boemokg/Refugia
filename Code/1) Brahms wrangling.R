...
#Read the shapefile 
thspp <- st_read("C:/Users/NHLKAG001/Downloads/TOCC_CapeProvinces/TOCC_CapeProvinces/TOCC_CapeProvinces.cpg.dbf")
...
saveRDS(NREs, file = "Data/NREs")
saveRDS(CapeFR_for_heatmap, file = "Data/CapeFR_for_heatmap")
saveRDS(SAspp, file = "Data/SAspp")
saveRDS(fynveg, file = "Data/fynveg")

#remove all data sets from the environment 
#rm(Alienspp,CapeFR, CapeFR_for_heatmap, fynveg, NREs, SAspp, thspp, duplicated_taxa, bigdat)
