...
FctNRE <- readRDS("Data/FctNRE.rds")
ObNRE <- readRDS("Data/obNRE.rds")
...
saveRDS(Richness.FCTNRE.QDS, file = "Data/Richness.FCTNRE.QDS.RDS")
saveRDS(Richness.ObNRE.QDS, file = "Data/Richness.ObNRE.QDS.RDS")
